    ...
    if app_path:
        ...
        if busy:
            ...
            if already:
                ...
                # страницу. Терять мамин вход при каждом запуске нельзя.
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Один помощник за раз. Двое одновременно уводят приложение в игру
    # каждый по-своему, и получаются два игровых окна.
    if not take_single_run():
        _say()
